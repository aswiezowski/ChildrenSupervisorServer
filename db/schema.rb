...
ActiveRecord::Schema.define(version: 20160528140421) do
  ...
  add_index "children", ["slug"], name: "index_children_on_slug", unique: true, using: :btree
  ...
  add_index "parents", ["slug"], name: "index_parents_on_slug", unique: true, using: :btree
